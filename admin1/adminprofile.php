        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-content pt-2">
            ...
            <div class="col-lg-3 col-md-4 label">Full Name</div>
             <div class="col-lg-9 col-md-8">
              <label for="full_name" class="form-control-label"><?= $row['full_name'] ?></label>
             </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 label">Email</div>
             <div class="col-lg-9 col-md-8">
              <label for="email" class="form-control-label"><?= $row['email'] ?></label>
             </div>
            </div>

            <div class="row">
            <div class="col-lg-3 col-md-4 label">PhoneNo</div>
             <div class="col-lg-9 col-md-8">
              <label for="phone_no" class="form-control-label"><?= $row['phone_no'] ?></label>
             </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 label">Gender</div>
             <div class="col-lg-9 col-md-8">
              <label for="gender" class="form-control-label"><?= $row['gender'] ?></label>
             </div>
            </div>
            <div class="row">
            <div class="col-lg-3 col-md-4 label">Address</div>
             <div class="col-lg-9 col-md-8">
              <label for="address" class="form-control-label"><?= $row['address'] ?></label>
             </div>
            </div>

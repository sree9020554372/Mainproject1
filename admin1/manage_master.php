...
?>                                  
              <tr>
                  ...
                  <td><img src="../images/<?php  echo $row['img'];?>"  width="100" height="100"> </td>
                  <td><img src="../images/<?php  echo $row['idproof'];?>"  width="100" height="100"> </td>
                  <td><img src="../images/<?php  echo $row['certificates'];?>" width="100" height="100"> </td>
                  <td> <?php echo htmlentities($row['username']);?></td>
                  <td> <?php echo htmlentities($row['password']);?></td>
                  <td><a style="color:blue" href="updatemaster.php?mid=<?php echo $row['mid'];?>"><b>Edit</a></td>
		        <td><a style="color:#F63" href="deletemaster.php?mid=<?php echo $row['mid'];?>"><b>Delete</a></td>

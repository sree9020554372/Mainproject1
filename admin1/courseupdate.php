...
$query= "UPDATE tbl_course, SET cname='$cname',cstart='$cstart',cost='$cost',images='$images',cstart='$cstart' where cid='$id'";
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="addcourse2.php">Add Classes</a></li>
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href=>Add Master</a></li>
    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                //{
                //$cid=$_GET['cid'];
                //$query=mysqli_query($conn, "SELECT * FROM tbl_category INNER JOIN tbl_course ON tbl_category.c_id = tbl_course.c_id INNER JOIN tbl_subcategory ON tbl_subcategory.subid = tbl_course.subid");
               // while($row=mysqli_fetch_array($query)) {
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-19">
                        <input type="text" name="cname" id="cname" class="form-control" value="<?php= $row['cname'] ?>">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-13"><label for="text-input" class=" form-control-label">cstart</label></div>
                    <div class="col-12 col-md-19"><input type="date" id="date" name="cstart" rows="9" placeholder="Content..." value="<?php= $row['cstart'] ?>" class="form-control"><small class="form-text text-muted"></small></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cost</label></div>
                    <div class="col-12 col-md-19"><input type="text" id="cost" name="cost" placeholder="enter cost" value="<?php= $row['cost'] ?>" class="form-control"><small class="form-text text-muted" ></small></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Images</label></div>
                    <div class="col-12 col-md-19"><input type="file" id="images" name="images" placeholder="" value="<?php= $row['images'] ?>" class="form-control"><small class="form-text text-muted" ></small></div>
                </div>

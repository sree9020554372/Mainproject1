                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">CRUISELINER</span>|<span class="font-size-xl text-primary">ADMIN</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-people"></i><span class="sidebar-mini-hide"></span>Head-Cook</a>
                                    <ul>
									
                                        <li>
                                            <a href="addheadcook.php">Add Headcook</a>
                                        </li>
                                        <li>
                                            <a href="viewheadcook.php">View Headcook</a>
                                        </li>
                                    </ul>
                                </li>
								<li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-people"></i><span class="sidebar-mini-hide">Waiters</span></a>
                                    <ul>
                                        <li>
                                            <a href="addwaiters.php">Add Waiters</a>
                                        </li>
                                        <li>
                                            <a href="viewwaiter.php">View Waiters</a>
                                        </li>
								...
								<li>
                                    <a  href="runningshow.php"><i class="fa fa-film"></i><span class="sidebar-mini-hide">Running Movies</span></a>

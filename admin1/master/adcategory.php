                                                        ...
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                           <!-- <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-19"><input type="text" id="cateogoryname" name="categoryname" placeholder="enter class name" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>

...
?>                                  
              <tr>
                  ...
                  <td><a style="color:blue" href=".php?aid=<?php echo $row['aid'];?>"><b>PRESENT</a></td>
		        <td><a style="color:#F63" href=".php?aid=<?php echo $row['aid'];?>"><b>ABSENT</a></td>
                <td><a style="color:#F63" href="deleteA.php?aid=<?php echo $row['aid'];?>"><b>Delete</a></td>

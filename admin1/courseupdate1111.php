...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <?php
$id=$_GET['cid'];
$query=mysqli_query($conn,"select * from tbl_course where cid='$id'and status='active'");
...
?>
                ...
                <div class="row form-group">
                    <div class="col col-md-13"><label for="select" class=" form-control-label" >Course name</label></div>
                    <div class="col-12 col-md-19">
                        <input type="text" name="cname" id="cname" class="form-control"  value="<?= ($row!=null) ? $row['cname'] : "Not Available" ?>" required onchange="validateCname();"  >
...
function validateCname() {
    ...
    return true;
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-19"><input type="date" id="date" name="cstart" rows="9" placeholder="Content..." value="<?= ($row!=null) ? $row['cstart'] : "Not Available" ?>" class="form-control"><small class="form-text text-muted"></small></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cost</label></div>
                    <div class="col-12 col-md-19"><input type="text" id="cost" name="cost" placeholder="enter cost" value="<?= ($row!=null) ? $row['cost'] : "Not Available" ?>" class="form-control" required onchange="validateInput();" ><small class="form-text text-muted" ></small></div>
    ...
    return true;
                ...
                <div class="row form-group">
                   <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">description</label></div>
                    <div class="col-12 col-md-9"><textarea name="description" id="description" rows="9" placeholder="Content..." class="form-control" onChange="maxlength1(this, 250)"  pattern="^(?:\b\w+\b[\s\r\n]*){1,250}$"><?php echo ($row!=null) ? $row['description'] : "Not Available" ?></textarea>
                   </div>

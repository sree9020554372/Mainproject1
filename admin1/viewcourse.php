...
?>                                  
              <tr>
                  ...
                  <td><a style="color:blue" href="courseupdate1111.php?cid=<?php echo $row['cid'];?>"><b>Edit</a></td>
		        <td><a style="color:#F63" href="deletecourse.php?cid=<?php echo $row['cid'];?>"><b>Delete</a></td>

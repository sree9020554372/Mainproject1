...
if(isset($_POST['send_otp'])){
    ...
    if($rsltCheck>0){
        ...
        if($data_check){
         ...
         $mail->Username   = 'sreelekshmianilkumar2023b@mca.ajce.in';                     //SMTP username
         $mail->Password   = 'Sree@2023';                               //SMTP password
         $mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
         $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
         
        //Recipients
         $mail->setFrom('sreelekshmianilkumar2023b@mca.ajce.in');
        ...
        //$sender_mail= "libiyajose2023b@mca.ajce.in";
        //$receiver_mail= $mail;
        ...
        //$mail->send();
         if($mail->send()){
        //if(mail($receiver_mail,$subject,$message,$sender_mail)){

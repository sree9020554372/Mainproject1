...
?>                                  
              <tr>
               ...
               <?php
                    if($row['status']==1){
                        echo '<p><a href="inactive.php?id='.$row['sh_id'].'$status=1">Disable</a></p>';
                    }else{
                        echo '<p><a href="active.php?id='.$row['sh_id'].'$status=0">Enable</a></p>';
                    }
                    ?>
               <td><a href="course_update.php?c_id=<?php echo $row['sh_id']?>">update</a></td>
              </tr>
              <?php $cnt=$cnt+1; } ?>

...
$duplicate=mysqli_query($conn, "SELECT * from tbl_login WHERE username='$username'");
      ...
      else
      {
        ...
        $sql="insert into tbl_login(`username`,`password`,`role`,`status`) VALUES ('$username','$password','master',3)";
		
        if($conn->query($sql)=== TRUE)
        {
            $val="select login_id from tbl_login where username='".$username."'";

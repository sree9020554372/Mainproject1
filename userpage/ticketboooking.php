                                    ...
                                    while ($raw = mysqli_fetch_array($result)){ ?>
                                        ...
                                        <form method="post"  enctype="multipart/form-data" action="">
                                            <div class="products-single fix">
                                                ...
                                                <div class="">
                                                    <h1 style="color: red;" align="center"><?php echo $raw['mname']; ?></h1>
                                                    
                                                
                                                    <a class="nav-link" id="<?php echo $raw['movieid']; ?>" href="ticketlistboooking.php?movieid=<?php echo $raw['movieid']; ?>" role="tab" aria-controls="<?php echo $raw['movieid']; ?>" aria-selected="true" align="center">Book Ticket</a>
                                                </div>
                                            </div>
                                            </form>
                                        </div>

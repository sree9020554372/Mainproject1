<?php
	...
	$sql="SELECT login_id from tbl_reg where login_id='$login_id'";
$resu = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($resu);
$login_d= $row['login_id'];

//$sql = mysqli_query($conn, "SELECT   tbl_reg.reg_id, tbl_reg.full_name ,tbl_reg.email , tbl_course.cname, tbl_course.cost,tbl_course.status 
//FROM tbl_reg, tbl_course 
//WHERE tbl_reg.cid = tbl_course.cid");
...
if(isset($_POST['BookNow']))
{
   ...
   $cost= $_POST['cost'];
   //$sql="SELECT login_id from tb_reg where login_id='$login_id'";
   //$resu = mysqli_query($conn, $sql);
   //$row = mysqli_fetch_assoc($resu);
   //$login_id= $row['login_id'];

   
   $query1=mysqli_query($conn," INSERT INTO `tbl_booking`(`bookid`,`login_id`, `studentname`, `email`,`coursename`,`cost`,`status`) VALUES('$bookid','$login_id','$studentname','$email','$coursename','$cost','active')");
...
//$sql = mysqli_query($conn, "SELECT   tbl_reg.reg_id, tbl_reg.full_name ,tbl_reg.email , tbl_course.cname, tbl_course.cost,tbl_course.status 
//FROM tbl_reg, tbl_course 
//WHERE tbl_reg.login_id = tbl_course.login_id");
$query=mysqli_query($conn,"select * from tbl_reg ");
...
?>
                                                           ...
                                                           <!-- <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-19"><input type="text" id="full_name" name="full_name" placeholder="" value="<?php $row['full_name']  ?>"  class="form-control"  ><small class="form-text text-muted"></small></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-13"><label for="text-input" class=" form-control-label">Email</label></div>
                                                                <div class="col-12 col-md-19"><input type="email" id="email" name="email" rows="9" placeholder="Content..."  class="form-control" value="<?php $row['email'] ?>"><small class="form-text text-muted"></small></div>
                                                            </div>    
                                                           <!-- <div class="row form-group">
                                       ...
                                       <div class="col-12 col-md-19"><input type="type" id="cname" name="cname" placeholder=""   class="form-control"><small class="form-text text-muted" value="<?php= $row['cname'] ?>"></small></div>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-19"><input type="text" id="cost" name="cost" placeholder=""  class="form-control" > <small class="form-text text-muted" value="<?php= $row['cname'] ?>"></small></div>
                                                            </div>

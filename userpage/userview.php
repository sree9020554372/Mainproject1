			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="viewshedule.php">Master</a></li>
            ...
            <div class="about-section-box">
		          <div class="container">
			           <div class="row">
                        ...
                        <?php
                            include('connection.php');
                            $data_res= mysqli_query($conn,"SELECT * FROM tbl_course ");
                            if($data_res){
                                    ...
                                    while($row= mysqli_fetch_array($data_res)){
                                        ...
                                        echo '
                                            <div class="animal-card" style="width: 18rem;">
                                                <img class="card-img-top" src="../images/'.$images.'"   alt="" height="200" width="100">
                                                <div class="card-body">

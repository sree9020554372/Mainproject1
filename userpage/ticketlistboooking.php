...
if($_SESSION['id']==""){
  ...
  $sid = $_GET['movieid'];
  $sql = mysqli_query($con,"SELECT * from movies where movies.movieid='$sid'");
...
<form method="post"  enctype="multipart/form-data" action="movieaction.php?movieid=<?php echo $sid  ?>">
<img src="<?php echo $imageurl; ?> " width="550px" style="border-radius:70px;margin-right:200px;margin-top:100px" >	
<h2 style="margin-left:720px;margin-top:-500px;font-weight:bold;font-size:30px"><?php echo $mname  ?> </h2>	

<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Cast:</b>&nbsp<?php echo $cast ?></h3><br>
<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Release Date:</b>&nbsp<?php echo $date ?></h4><br>
<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Description:</b>&nbsp<?php echo $description ?></h4><br>
<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Show Time:</b>&nbsp<?php echo $time ?></h4><br>
<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Screen:</b>&nbsp<?php echo $screen ?></h4><br>
<h4 style="margin-left:720px;"><b style="font-weight:bold;font-size:22px">Price:</b>&nbsp<?php echo $pprice ?></h4><br>
<div class="form-group quantity-box" style="width:100px">
    <label class="control-label" style="margin-left:720px">Seats&nbsp:</label>
    <input class="form-control" name="seats" value="1" min="1" max="50" type="number" style="margin-left:720px">
 </div>

<input type="submit" name="movie" value="Book Ticket" style="height: 50px;color: #fff;  background: #146eb4; width: 200px;font-size: initial;font-weight: 900;margin-left:720px;margin-top:100px">

				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="addleave.php">view class</a>
	...
	<div class="menu-box">
		<div class="container">
            ...
            <div class="animated fadeIn">
              ...
              <?php
              include 'connection.php';
              $query=mysqli_query($conn, $sql = "SELECT  * FROM tbl_leave WHERE STATUS='active'");
...
?>                                  
              <tr>
                  ...
                  <td><a style="color:#F63" href="deleteleave.php?leaveid=<?php echo $row['leaveid'];?>"><b>Delete</a></td>

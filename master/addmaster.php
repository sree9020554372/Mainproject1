...
else
{
    ...
    $query1=mysqli_query($conn," INSERT INTO `tbl_master`(`name`, `email`,`phoneno`,`age`,`gender`,`img`,`username`,`password`,`status` ) VALUES('$name','$email','$phoneno','$age',' $gender','$img','$username','$password','active')");
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="">Add Schedule</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="">Manage Shedule</a></li>
                        </ul>
                    </li>
                   <!-- <li class="menu-item-has-children active dropdown">
            ...
            <div class="animated fadeIn">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-19"><input type="text" id="name" name="name" placeholder="enter  name"   class="form-control" ><small class="form-text text-muted"></small></div>
                                                            </div>
                                                            <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-19"><input type="number" id="phoneno" name="phoneno" placeholder="enter phone no" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Age</label></div>
                                                                <div class="col-12 col-md-19"><input type="type" id="age" name="age" placeholder="enter Age" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
                                            ...
                                            <span class="gender">others</span>
                                                            ...
                                                            <div class="row form-group">
                                                                   ...
                                                                   <div class="col-12 col-md-19"><input type="file" id="img" name="img" placeholder="" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div> 
                                                            <!--<div class="row form-group">
                                                           ...
                                                           <!-- <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-19"><input type="type" id="username" name="username" placeholder="enter username" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
                                                                <div class="col-12 col-md-19"><input type="password" id="password" name="password" placeholder="enter password" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>

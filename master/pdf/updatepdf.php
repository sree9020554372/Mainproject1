<?php
        ...
        if (isset($_POST['submit'])) {
          ...
          $query="UPDATE pdf_file SET pdf='$pdf' where id='$id' ";
$query_run=mysqli_query($conn,$query);
if ($query) {
    echo "<script>alert('pdf has been updated added.');</script>"; 
                                                        ...
                                                        <form action="insert.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                           <!-- <div class="row form-group">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-19"><input type="file" id="pdf" name="pdf" placeholder="" class="form-control" value="<?= ($row!=null) ? $row['pdf'] : "Not Available" ?>"><small class="form-text text-muted"></small></div>
                                                            </div>
                                                            ...
                                                            <input type="hidden" class="btn btn-primary" value="id" name="id" id="id">

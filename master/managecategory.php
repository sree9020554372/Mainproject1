                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="">Manage category</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children active dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Add Class</a>
                        <ul class="sub-menu children dropdown-menu">
...
<tr>
               ...
               <?php
                    ...
                    ?>
               <td><a href="courseupdate.php?cid=<?php echo $row['cid']?>">update</a></td>
              </tr>
              <?php $cnt=$cnt+1; } ?>

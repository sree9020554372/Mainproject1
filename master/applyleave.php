...
if(isset($_POST['mid']))
  {
    $mid=$_POST['mid'];
$sql=mysqli_query($conn,"SELECT * FROM tbl_master WHERE mid='$mid'  AND status='active'"); 
...
?>
 ...
 <div class="row form-group" >
    ...
    <div class="col-12 col-md-19"><input type="text" id="name" name="name" placeholder=""  value="<?= ($row!=null) ? $row['name'] : "Not Available" ?>" class="form-control" required onchange="validateInput();" ></div>

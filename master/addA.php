...
if(isset($_POST['submit']))
  {
    ...
    $date=$_POST['date'];
    $query=mysqli_query($conn, "insert into  tbl_attend( studentname, coursename,date, status ) value('$studentname','$coursename' ,'$date','active')");
    if ($query) {
    	echo "<script>alert('Attendence has been added.');</script>"; 
    		echo "<script>window.location.href = 'addA.php'</script>";   
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Add Category</h3><!-- /.menu-title -->
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        ...
                                                        <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-19"><input type="text" id="studentname" name="studentname" placeholder="enter  name"   class="form-control" required onchange="validateInput();" ></div>
...
function validateInput() {
    ...
    return true;
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">coursename</label></div>
                                                                <div class="col-12 col-md-19"><input type="type" id="coursename" name="coursename" placeholder="" class="form-control" required onchange="ValidQualification();"></div>
...
function ValidQualification() {
    ...
    return true;
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-13"><label for="text-input" class=" form-control-label">Date</label></div>
                                                                <div class="col-12 col-md-19"><input type="date" id="date" name="date" rows="9" placeholder="Content..." class="form-control"><small class="form-text text-muted"></small></div>

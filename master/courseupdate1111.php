...
?>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-19">
                        <input type="text" name="cname" id="cname" class="form-control"  value="<?= ($row!=null) ? $row['cname'] : "Not Available" ?>" >
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-19"><input type="text" id="cost" name="cost" placeholder="enter cost" value="<?= ($row!=null) ? $row['cost'] : "Not Available" ?>" class="form-control"><small class="form-text text-muted" ></small></div>
                </div>
                <div class="row form-group">
                   <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">description</label></div>
                    <div class="col-12 col-md-9"><textarea name="description" id="description" rows="9" placeholder="Content..." class="form-control"><?php echo ($row!=null) ? $row['description'] : "Not Available" ?></textarea>
</div>
                </div>
                <!--<div class="row form-group">
